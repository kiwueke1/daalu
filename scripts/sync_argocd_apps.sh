...
ARGOCD_SYNC_TIMEOUT_SECONDS="${ARGOCD_SYNC_TIMEOUT_SECONDS:-1000}"
ARGOCD_WAIT_TIMEOUT_SECONDS="${ARGOCD_WAIT_TIMEOUT_SECONDS:-700}"
...
MY_REPO_URL="git@github.com:kiwueke1/argocd-infrastructure-app.git"
MY_REPO_NAME="argocd-infrastructure-app"
MY_REPO_BRANCH="main"

echo ""
echo_blue "=========================================================================================="
echo_blue "Registering Git repo with ArgoCD..."
echo_blue "------------------------------------------------------------------------------------------"
echo_blue "Repo: $MY_REPO_URL"
echo_blue "Name: $MY_REPO_NAME"
echo_blue "Branch: $MY_REPO_BRANCH"
echo_blue "=========================================================================================="

set +e
echo_blue "Registering Git repo with ArgoCD via SSH key..."
argocd repo add "$MY_REPO_URL" \
  --name "$MY_REPO_NAME" \
  --ssh-private-key-path ~/.ssh/openstack-key \
  --upsert
echo_green ">>> Repo registration complete (SSH)"
set -e

echo_green ">>> Repo registration complete"
